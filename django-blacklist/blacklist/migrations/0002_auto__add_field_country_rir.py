...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Country.rir'
        db.add_column('blacklist_country', 'rir', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blacklist.RIR'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.rir'
        db.delete_column('blacklist_country', 'rir_id')
