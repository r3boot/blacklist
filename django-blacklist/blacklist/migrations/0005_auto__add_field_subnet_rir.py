...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subnet.rir'
        db.add_column('blacklist_subnet', 'rir', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blacklist.RIR'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subnet.rir'
        db.delete_column('blacklist_subnet', 'rir_id')
