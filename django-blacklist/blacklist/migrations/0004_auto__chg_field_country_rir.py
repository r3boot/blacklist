...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Country.rir'
        db.alter_column('blacklist_country', 'rir_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['blacklist.RIR']))


    def backwards(self, orm):
        
        # Changing field 'Country.rir'
        db.alter_column('blacklist_country', 'rir_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blacklist.RIR'], null=True))
